...
def generate_ai_object_name(category: str, physics_data: str = "") -> str:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"⚠️ API Key active but rejected: Status {response.status_code}")
...
def run_simulation_step():
    try:
        # CLEANUP: Delete rogue rows so the frontend app doesn't freeze on old data
        ...
        possible_spawns = [("nebulae", "Nebula Cloud", "Gas Temp: 18 K, Density: 10^4/cm³, H2/He Composition")]
